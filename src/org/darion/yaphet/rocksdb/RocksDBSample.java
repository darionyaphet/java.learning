...
public class RocksDBSample {
	...
	public static void main(String[] args) {
		...
		try {
			options.setCreateIfMissing(true).createStatistics().setWriteBufferSize(8 * SizeUnit.KB)
		...
		try {
			...
			byte[] testValue = "asdfghjkl;'?><MNBVCXZQWERTYUIOP{+_)(*&^%$#@".getBytes();
