...
public class RocksDBColumnFamilySample {
	...
	public static void main(String[] args) throws RocksDBException {
		...
		try {
			db = RocksDB.open(new DBOptions(), db_path, columnFamilyDescriptors, columnFamilyHandles);
			assert (db != null);

			// put and get from non-default column family
			db.put(columnFamilyHandles.get(0), new WriteOptions(), "key".getBytes(), "value".getBytes());
			String value = new String(db.get(columnFamilyHandles.get(0), "key".getBytes()));
